        ...
        <div className="min-h-screen bg-orange-100 text-slate-800 font-hind pb-24">
            ...
            <section className="relative h-[250px] lg:h-[350px] flex items-center overflow-hidden bg-orange-200/50">
                <div className="absolute inset-0 z-0">
                    <img
                        ...
                        alt="Pay Bill Header"
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-orange-100 via-orange-100/80 to-transparent"></div>
                </div>
                ...
                <div className="max-w-[1400px] mx-auto w-full px-4 lg:px-6 relative z-10">
                    <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="max-w-2xl">
                        <h1 className="text-4xl lg:text-6xl font-black mb-3 text-orange-900 font-poppins tracking-tight uppercase">
                            How to <span className="text-orange-600">Pay?</span>
                        </h1>
                        <p className="text-slate-600 text-base lg:text-lg font-medium leading-relaxed font-hind opacity-80">
            ...
            <div className="max-w-[1400px] mx-auto px-4 lg:px-6 relative z-20">
                ...
                <motion.div
                    ...
                    className="bg-white rounded-[2rem] p-6 lg:p-8 -mt-12 shadow-[0_15px_40px_rgba(124,45,18,0.1)] border border-orange-200/50"
                >
                            ...
                            <div className="flex flex-col md:flex-row gap-3">
                                <div className="flex-grow relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-orange-50/50 border-2 border-orange-100 rounded-xl py-3.5 pl-12 pr-4 outline-none focus:border-orange-500 focus:bg-white transition-all text-base font-bold font-poppins"
                                        onChange={(e) => setCustomerId(e.target.value)}
                                    />
                                </div>
                                <button className="bg-orange-600 hover:bg-orange-700 text-white font-black px-8 py-3.5 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 active:scale-95 whitespace-nowrap font-poppins text-sm">
                ...
                <div className="mt-20 space-y-12">
                    {payBillData.paymentMethods.map((method, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-white rounded-[2.5rem] overflow-hidden shadow-xl border border-orange-200/50"
                        >
                            <div className={`flex flex-col lg:flex-row items-stretch ${index % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                                <div className="w-full lg:w-1/2 bg-gradient-to-br from-orange-50 to-white flex items-center justify-center p-6 lg:p-10 border-b lg:border-b-0 border-orange-100">
                                    <img
                                        src={method.appImage}
                                ...
                                <div className="w-full lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
                                    <div className="inline-block px-3 py-1 bg-orange-100 text-orange-600 rounded-full text-[9px] font-black mb-4 tracking-[0.2em] font-poppins uppercase w-fit">
                                        Instruction Guide
                                    </div>
                                    <h2 className="text-2xl lg:text-4xl font-black text-slate-900 mb-6 leading-tight font-hind">
                                        পেমেন্ট করুন <span className="text-orange-600">{method.name}</span> দিয়ে
                                    </h2>
                                    <div className="space-y-2">
                                        {method.steps.map((step, i) => (
                                            <div key={i} className="flex items-center gap-3 p-2 lg:p-3 bg-orange-50/50 rounded-xl border border-transparent hover:border-orange-200 transition-all group">
                                                <span className="w-7 h-7 lg:w-8 lg:h-8 bg-white text-orange-600 rounded-lg flex items-center justify-center font-black shrink-0 shadow-sm border border-orange-100 text-xs lg:text-sm font-poppins">{i + 1}</span>
                ...
                <section className="mt-16">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="w-full bg-white rounded-[2.5rem] p-8 lg:p-14 shadow-2xl relative overflow-hidden group border border-orange-200/50"
                    >
                        <div className="absolute right-0 top-0 w-full lg:w-1/2 h-full pointer-events-none z-0">
                            <div className="absolute right-[-5%] top-1/2 -translate-y-1/2 w-[300px] h-[200px] lg:w-[550px] lg:h-[350px] bg-orange-50/40 rounded-[2.5rem] border border-orange-100 rotate-[-8deg] group-hover:rotate-0 transition-transform duration-1000"></div>
                        </div>
                        ...
                        <div className="relative z-10 w-full lg:w-3/5">
                            <h2 className="text-3xl lg:text-6xl font-black text-slate-900 mb-8 font-poppins tracking-tight leading-tight">
                                Want to pay with <span className="text-orange-600">Master/Visa</span> card?
                            </h2>
                            <div className="flex items-center gap-4 mb-10">
                                <input type="checkbox" id="visa-pay-terms" className="w-6 h-6 rounded-md border-orange-300 text-orange-600 focus:ring-orange-500 cursor-pointer accent-orange-600 transition-all" />
                            ...
                            <button className="bg-orange-600 hover:bg-orange-700 text-white font-black px-12 py-4.5 rounded-2xl transition-all shadow-[0_10px_30px_rgba(234,88,12,0.3)] flex items-center gap-3 active:scale-95 whitespace-nowrap font-poppins text-lg uppercase tracking-widest">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {payBillData.banks.map((bank) => (
                            <motion.div
                                key={bank.id}
                                whileHover={{ y: -5 }}
                                className="bg-white p-6 lg:p-8 rounded-[2rem] shadow-lg border border-orange-50 hover:border-orange-500 transition-all group flex flex-col justify-between"
                            >
                                {/* উপরের অংশ: লোগো ও টাইটেল */}
                                <div>
                                    <div className="bg-orange-50/50 p-2.5 rounded-xl mb-4 w-fit group-hover:bg-orange-600 transition-colors duration-300">
                                        <img
                                            src={bank.logo}
                                ...
                                <div className="space-y-2.5">
                                    {[
                                        ...
                                        <div key={idx} className="flex flex-col border-b border-orange-50/50 pb-1">
                                            <span className="text-[9px] uppercase font-black text-orange-400 tracking-widest font-poppins">
                                                {info.label}
                                            </span>
