        ...
        <div className="min-h-screen bg-orange-100 text-slate-800 font-hind pb-24">
            ...
            <section className="relative h-[300px] lg:h-[400px] flex items-center overflow-hidden">
                ...
                <div className="container mx-auto px-6 lg:px-20 relative z-10">
                    <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="max-w-2xl">
                        <h1 className="text-5xl lg:text-8xl font-black mb-4 text-orange-900 font-poppins tracking-tighter uppercase italic">
                            Pay <span className="text-orange-600">Service</span>
                        </h1>
            ...
            <div className="container mx-auto px-4 lg:px-10 relative z-20">
                    ...
                    {serviceList.map((service) => (
                        <motion.div 
                            ...
                            ${selectedService === service.name 
                                ? 'bg-orange-600 border-orange-600 text-white shadow-orange-500/40' 
                                : 'bg-white border-orange-100 text-slate-700 hover:border-orange-500'}`}
                        >
                            {/* শাইন ইফেক্ট */}
                            ...
                            <div className={`mb-4 p-4 rounded-2xl transition-colors ${selectedService === service.name ? 'bg-white/20' : 'bg-orange-50 text-orange-600'}`}>
                                {service.icon}
                            </div>
                ...
                <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="max-w-4xl mx-auto bg-white rounded-[3rem] p-8 lg:p-16 shadow-[0_30px_70px_rgba(124,45,18,0.12)] border border-orange-200"
                >
                    <div className="text-center mb-12">
                        <div className="bg-orange-50 text-orange-600 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest inline-block mb-4 font-poppins">Secured Portal</div>
                    ...
                    <form className="space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-orange-500 uppercase tracking-widest ml-1 font-poppins">Selected Service</label>
                                <input 
                                    type="text" 
                                    value={selectedService || "Please select a service"} 
                                    readOnly 
                                    className="w-full bg-orange-50/50 border-2 border-orange-100 rounded-2xl py-4 px-6 outline-none font-black text-orange-900 font-poppins shadow-inner"
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    <div className="absolute left-5 top-1/2 -translate-y-1/2 text-orange-400 group-focus-within:text-orange-600 transition-colors">
                                        <User size={20} />
                                    </div>
                                    <input 
                                        type="text" 
                                        placeholder="Ex: 017XXXXXXXX" 
                                        className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-4 pl-14 pr-6 outline-none focus:border-orange-500 focus:bg-white transition-all font-bold text-slate-800 placeholder:text-slate-300"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <div className="absolute left-6 top-1/2 -translate-y-1/2 text-orange-600 text-2xl font-black">৳</div>
                                <input 
                                    type="number" 
                                    placeholder="0.00" 
                                    className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-5 pl-14 pr-6 outline-none focus:border-orange-500 focus:bg-white transition-all text-3xl font-black text-slate-900"
                                />
                            </div>
                        </div>

                        {/* পে বাটন */}
                        <button className="relative group/btn w-full bg-orange-600 hover:bg-orange-700 text-white font-black py-5 rounded-2xl flex items-center justify-center gap-3 shadow-xl shadow-orange-600/30 transition-all active:scale-95 text-xl font-poppins uppercase tracking-widest overflow-hidden">
                    ...
                    {/* পেমেন্ট পার্টনারস */}
                    <div className="mt-12 pt-10 border-t border-orange-100 flex flex-col items-center">
